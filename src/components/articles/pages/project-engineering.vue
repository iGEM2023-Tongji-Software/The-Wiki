...
<template>
    <article-page title="ENGINEERING">
        <template #default>
            ...
            <next-prev-page next-link="/tongji-software/contribution" next-title="PROJECT CONTRIBUTION" prev-link="/tongji-software/project/model" prev-title="PROJECT MODEL" />
        </template>
    </article-page>
</template>
